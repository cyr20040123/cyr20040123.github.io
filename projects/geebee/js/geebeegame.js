...
function init(){
    ...
    drawInfo("Use MOUSE or KEY [←][→] / [A][D] to move paddle.",400,720,20,"yellow");
    drawScore();
    ...
    var blob = new Blob([testCSV], {type: "text/plain;charset=utf-8"});
    saveAs(blob, "pixels.csv");
    alert("Test csv file done!");*/
}

function setSpeed() {
    ball.v = Math.floor(Math.log10(score+1))+initialBallSpeed;
